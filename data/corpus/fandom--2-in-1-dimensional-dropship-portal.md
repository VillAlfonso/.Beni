...
The 2-in-1 Dimensional Dropship/Portal is a toy set released under the Tenkai Knights toy line by Spin Master, Happinet, and Academy.

## Description

When called upon to battle against Vilius’ Corrupted army - there’s really only one way to get there: Instantaneous teleportation through a Dimensional Portal! Hidden within Mr. White’s shop lies the incredible shapeshifting Dimensional Portal– the gateway to Quarton. Once activated by the shapeshifting cores, the Dimensional Portal instantly thrusts Guren, Ceylan, Chooki, and Toxsa to the far reaches of the universe where they emerge as the Tenkai knights! Build the Portal and activate the Tenkai power inside. Use the shapeshifting power brick that contains a real working dimensional transport beam to bring the Tenkai Knights from Earth to Quarton for their next epic battle. Once in Quarton, the Portal can also shapeshift into the powerful flying aircraft manned by the Tenkai Knights. Cruising the skies, the Dimensional Dropship is a powerful weapon used to fight off the Corrupted Army when the battle rages. Take the fight into your own hands by rebuilding the Dimensional Portal into the Dimensional Dropship to launch an aerial attack. Weaponize the Dropship with 2 shapeshifting action bricks and take aim and at the Hos and Sho with real working crossbows. Load the undercarriage with two shapeshifting action bricks featuring powerful triple barrel missile launchers. When the battle heats up, crank up the speed and activate the real working blue thruster energy beam from the power brick. Swoop down on the Corrupted with the poseable wings, open the storage compartment from the bottom of the Dropship, and have the Corekai warriors leap into the battle for more firepower. IONIX: the revolutionary line of never before seen construction bricks that change their shape before your eyes! These construction bricks shapeshift and change to become mini figures, action figures, weapons, gear, gadgets, and more. What's more, our bricks snap together with other leading construction systems. IONIX: Shapeshift, build, unleash!
...
- 2 Weapon Bricks
- 2 Action Bricks
- 1 Exclusive Guardian Boreas Mini Figure
...
【Wビークル ポータル&ハイパー・ドロップシップ】
2つの形状にモードチェンジできるブロック兵器。ボリューム感ある形状なので、遊びがい十分! !
※ベーシックフィギュア1体付き:「ガーディアン・ボレアース」

ポータル・・・地球と惑星キューブを亜空間経由でつなぐための転送装置(ディメンショントランスポーター)。
ハイパー・ドロップシップ・・・ポータルがモードチェンジした輸送機。地球と惑星キューブ二つの世界を行き来できる希望の船。

[セット内容]Wビークル限定ベーシックフィギュア1体付き:1「ガーディアン・ボレアース」
