...
- 97 Pieces
- 1 Exclusive Tributon Shapeshifting Mini-Figure Brick
- 1 Exclusive Pivix Shapeshifting Mini-Figure Brick
- 1 Action Brick
- 1 Shapeshifting Titan Brick
- 93 Additional Pieces
- Instruction Guide

## Description

【Wビークル デストロイ・グリフォン&ボルト・ジェット】
2つの形状にモードチェンジできるブロック兵器。ボリューム感ある形状なので、遊びがい十分! !
※ベーシックフィギュア2体付き:「ヴィクリプス・ソルジャー」「トリビュトン(特別仕様版)」

デストロイ・グリフォン・・・大きな翼を待ったビーストロボ、デストロイ・グリフォン。咆哮とともに口から赤い光弾を撃ち出す。
ボルト・ジェット・・・スペクトロス軍の飛行部隊が誇る戦闘機。翼のビームガンより強力な青いビームを放つ。

[セット内容]Wビークル限定ベーシックフィギュア2体付き:1トリビュトン(Wビークル限定仕様版) 2「ヴィクリプス・ソルジャー」
