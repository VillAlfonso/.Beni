...
- The 2-in-1 Blastank and War Stallion let’s you build both a powerful Tenkai tank and evil mechanical war-beast by reconfiguring the same Titan Brick in 2 unique ways!
- Unleash the power of 2 shapeshifting action bricks by launching missiles at your opponents.
- Control the War Stallion with the Corrupted Dromus and take charge of the Blastank with the heroic Leinad.
...
- 1 Exclusive Dromus Shapeshifting Mini-Figure Brick
- 1 Exclusive Leinad Shapeshifting Mini-Figure Brick
- 143 Additional Pieces
- Instruction Guide

## Description

【Wビークル ウォー・ホース&ストライク・バスター・タンク】
2つの形状にモードチェンジできるブロック兵器。ボリューム感ある形状なので、遊びがい十分! !
※ベーシックフィギュア2体付き:「黒騎士」、「スペクトロス・レッドコマンダー」

ウォー・ホース・・・闇に怪しく光る赤い眼を持つビーストロボ。砂塵を巻き上げ荒野を駆ける重装備のメカニック・ホースだ。
ストライク・バスター・タンク・・・四つのキャタピラで轟音を響かせて突き進む地上用戦闘メカ。分厚い装甲に重武装はスペクトロス軍の強い味方だ。

[セット内容]Wビークル限定ベーシックフィギュア2体付き:1「黒騎士」 2「スペクトロス・レッドコマンダー」
