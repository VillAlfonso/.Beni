...
kind: character
episode: null
url: "https://tenkai-knights.fandom.com/wiki/Toxsa_Dalton"
---
...
Tenkai Knight: Valorn
First Appearance: Two Worlds (cameo)
Tenkai Dragon Cube (as Valorn)
The Rising Fire (actual appearance)}}
...
<!--ep:23-->
- Toxsa's hair (like Wakamei's) is green because his father's hair is blonde, and his mother's hair is teal.
- He makes many references to his video games. This includes the famous phrase "all you're base are belong to us."
- Part of Toxsa's Japanese family name, "Kame" (Japanese: 亀), in English means turtle, which is what Valorn's armor is based from.
- Toxsa seems to love cats, as shown in "Dragon Key Quest".
- Toxsa is the youngest of the team.
- As proved from his age Toxsa is shorter than all the Knights.
- Toxsa has allergies, presumably to dust, as shown in episode 6.
- Toxsa's hair is almost similar to Axl from Megaman X7.
...
<!--ep:43-->
Toxsa and Chooki are the closest together in the group, like when they worked as a team in "Tenkai Dragon Cube", "The Rising Fire", and in "Scorpidon". When Chooki got turned to a statue and Toxsa said "You're gonna pay for that!", it means that Toxsa and Chooki are the closest from Guren and Ceylan.
...
<!--ep:12-->
In "Dragon's Key", the boys split into two groups, Toxsa and Ceylan waited on Quarton with Beag at the Dragons Nest while Guren and Chooki searched for the White Dragon Key on Earth. Toxsa and Ceylan fought to hold the Corrupted off. Once Guren and Chooki arrived with the key, Toxsa watched as the Tenkai Dragon was awakened, and later captured by Dromus.
...
In "Robofusion!", Mr. White takes the boys fishing. Despite Chooki's warnings, Toxsa manages to catch a fish.

<!--ep:18-->
When Toxsa meets Beni for the first time in "The Key to Evil", he's upset that Guren didn't tell him and the others about her.
